...
for i = 1:length(file_paths)
    ...
    voltage_augmented = buffer.meas.Voltage;
    voltage = [voltage; voltage_augmented];
    avg_voltage = [avg_voltage; movmean(voltage_augmented, avg_samples)];
    current_augmented = buffer.meas.Current;
    current = [current; current_augmented];
    avg_current = [avg_current; movmean(current_augmented, avg_samples)];
    temp_augmented = buffer.meas.Battery_Temp_degC;
